...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col w-full items-center p-2">
      ...
      <div className="flex min-h-[50lvh] w-full p-2 bg-gradient-to-tl from-transparent to-slate-600 rounded-lg mt-2 h-100%">
        <h1 className="text-black font-bold text-2xl text-center bg-white rounded-lg px-2 m-2 h-8 justify- items-center"> Select your personal list:</h1>
      </div>
